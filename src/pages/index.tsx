  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="a digital representation of it. Experience the future of creativity with AI Arte, where your imagination meets artificial intelligence."
        />
      </Head>
      ...
      <Stack minH={'100vh'} direction={{ base: 'column', md: 'row' }}>
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`a digital representation of it. Experience the future of creativity with AI Arte, where your imagination meets artificial intelligence.`}
            </Text>
        ...
        <Flex position="relative" flex={1}>
          <Image
            src={
              'https://images.unsplash.com/photo-1655720031554-a929595ffad7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxhcnQlMkNBSXxlbnwwfHx8fDE2ODgyNTg4NTl8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt={'Login Image'}
            objectFit={'cover'}
          />
